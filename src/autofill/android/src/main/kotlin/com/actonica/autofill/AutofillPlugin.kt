                        ...
                        datasets.forEach {
                            ...
                            if (hints != null && hints.isNotEmpty()) {
                                ...
                                hints.forEach {
                                    ...
                                    Log.v(TAG, "setAutofillValues hint: ${hint}, valueForHint: ${valueForHint}, labelForHint: ${labelForHint}, autofillIdData: $autofillIdData")

                                    val autofillIds = intent.getParcelableArrayExtra(PassboltAutofillService.INTENT_EXTRAS_AUTOFILLIDS)
                                    ...
                                    val presentation = if (labelForHint.isEmpty()) {
                                        ...
                                        RemoteViews(packageName, R.layout.value_with_label).apply {
                                            setTextViewText(
                                                R.id.hintValue,
